System.register(["./utils/IntervalHelper", "./utils", "./app.worker", "./app"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var IntervalHelper_1, utils_1, app_worker_1, app_1, ParsedTreeHandler;
    return {
        setters: [
            function (IntervalHelper_1_1) {
                IntervalHelper_1 = IntervalHelper_1_1;
            },
            function (utils_1_1) {
                utils_1 = utils_1_1;
            },
        ...
        execute: function () {
            ;
            ;
            ParsedTreeHandler = class ParsedTreeHandler {
            ...
            exports_1("ParsedTreeHandler", ParsedTreeHandler);
        }
    };
});
