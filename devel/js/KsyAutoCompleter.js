define(["require", "exports", "ace/ext-language_tools"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class YamlHelper {
        static getLineInfoFromYaml(yaml) {
            const lineDict = {};
            function parseObject(path, currNode) {
                if (currNode.$meta)
