System.register(["goldenlayout", "./HexViewer"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var GoldenLayout, HexViewer_1, LayoutManager, UI;
    return {
        setters: [
            function (GoldenLayout_1) {
                GoldenLayout = GoldenLayout_1;
            },
            function (HexViewer_1_1) {
                HexViewer_1 = HexViewer_1_1;
            }
        ],
        execute: function () {
