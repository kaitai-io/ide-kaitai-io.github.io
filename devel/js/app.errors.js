System.register(["./utils", "./app"], function (exports_1, context_1) {
    "use strict";
    ...
    var utils_1, app_1, ErrorWindowHandler;
    return {
        setters: [
            function (utils_1_1) {
                utils_1 = utils_1_1;
        ...
        execute: function () {
            ErrorWindowHandler = class ErrorWindowHandler {
            ...
            exports_1("ErrorWindowHandler", ErrorWindowHandler);
        }
    };
});
