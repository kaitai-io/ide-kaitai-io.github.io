System.register(["./../../FileSystem/GithubClient", "./../../FileSystem/GithubFileSystem", "./../../FileSystem/BrowserFileSystem", "./../../FileSystem/RemoteFileSystem", "./../../FileSystem/StaticFileSystem", "../../FileSystem/HttpFileSystem", "./../../FileSystem/FsUri", "./../../FileSystem/FsSelector", "vue", "./../Component", "../Components/ContextMenu", "../Components/InputModal", "../../utils"], function (exports_1, context_1) {
    "use strict";
    ...
    var GithubClient_1, GithubFileSystem_1, BrowserFileSystem_1, RemoteFileSystem_1, StaticFileSystem_1, HttpFileSystem_1, FsUri_1, FsSelector_1, Vue, Component_1, utils_1, i, queryParams, fss, remoteFs, githubClient, githubFs, staticFs, httpFs, FsTreeNode, FsRootNode, fsData, FileTree;
    return {
        setters: [
            function (GithubClient_1_1) {
                GithubClient_1 = GithubClient_1_1;
            },
            function (GithubFileSystem_1_1) {
                GithubFileSystem_1 = GithubFileSystem_1_1;
            },
            function (BrowserFileSystem_1_1) {
                BrowserFileSystem_1 = BrowserFileSystem_1_1;
            },
            function (RemoteFileSystem_1_1) {
                RemoteFileSystem_1 = RemoteFileSystem_1_1;
            },
            function (StaticFileSystem_1_1) {
                StaticFileSystem_1 = StaticFileSystem_1_1;
            },
            function (HttpFileSystem_1_1) {
                HttpFileSystem_1 = HttpFileSystem_1_1;
            },
            function (FsUri_1_1) {
                FsUri_1 = FsUri_1_1;
            },
            function (FsSelector_1_1) {
                FsSelector_1 = FsSelector_1_1;
            },
            function (Vue_1) {
                Vue = Vue_1;
            },
        ...
        execute: function () {
            ...
            fss = new FsSelector_1.FsSelector();
            fss.addFs(new BrowserFileSystem_1.BrowserFileSystem());
            fss.addFs(new BrowserFileSystem_1.BrowserLegacyFileSystem());
            remoteFs = new RemoteFileSystem_1.RemoteFileSystem();
            remoteFs.mappings["127.0.0.1:8001/default"] = { secret: queryParams.secret };
            fss.addFs(remoteFs);
            githubClient = new GithubClient_1.GithubClient(queryParams.access_token);
            githubFs = new GithubFileSystem_1.GithubFileSystem(githubClient);
            fss.addFs(githubFs);
            staticFs = new StaticFileSystem_1.StaticFileSystem();
            kaitaiFsFiles.forEach(fn => staticFs.write("static://" + fn, new ArrayBuffer(0)));
            fss.addFs(staticFs);
            httpFs = new HttpFileSystem_1.HttpFileSystem(kaitaiFsFiles.reduce((obj, fn) => { obj[`/${fn}`] = getRelativeUrl(fn); return obj; }, {}));
            console.log(httpFs.fileUrls);
            fss.addFs(httpFs);
            FsTreeNode = class FsTreeNode {
            ...
            exports_1("FsTreeNode", FsTreeNode);
            FsRootNode = class FsRootNode {
            ...
            FileTree = class FileTree extends Vue {
