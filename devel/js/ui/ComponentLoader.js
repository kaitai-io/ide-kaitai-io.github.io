System.register(["vue", "jquery"], function (exports_1, context_1) {
    "use strict";
    ...
    var Vue, $, ComponentLoader, componentLoader;
    return {
        setters: [
            function (Vue_1) {
                Vue = Vue_1;
        ...
        execute: function () {
            ...
            ;
            window["vue"] = Vue;
            exports_1("componentLoader", componentLoader = new ComponentLoader());
        }
    };
});
