System.register(["vue", "../Component", "../UIHelper"], function (exports_1, context_1) {
    "use strict";
    ...
    var Vue, Component_1, UIHelper_1, TreeView, TreeViewItem;
    return {
        setters: [
            function (Vue_1) {
                Vue = Vue_1;
        ...
        execute: function () {
            ...
            TreeView = class TreeView extends Vue {
                constructor() {
                    super(...arguments);
            ...
            TreeViewItem = class TreeViewItem extends Vue {
                constructor() {
                    super(...arguments);
                    this.open = false;
                    this.selected = false;
            ...
            exports_1("TreeViewItem", TreeViewItem);
        }
    };
});
