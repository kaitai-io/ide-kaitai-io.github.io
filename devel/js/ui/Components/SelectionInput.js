System.register(["vue", "../Component"], function (exports_1, context_1) {
    ...
    var Vue, Component_1, SelectionInputPart, SelectionInput;
    return {
        setters: [
            function (Vue_1) {
                Vue = Vue_1;
        ...
        execute: function () {
            SelectionInputPart = class SelectionInputPart extends Vue {
                constructor() {
                    super(...arguments);
                    this.text = "";
                    this.focused = false;
            ...
            exports_1("SelectionInputPart", SelectionInputPart);
            SelectionInput = class SelectionInput extends Vue {
                constructor() {
                    super(...arguments);
            ...
            exports_1("SelectionInput", SelectionInput);
        }
    };
});
